# -*- coding: utf-8 -*-
"""Predictive analysis gym

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14BYtJO7p_pJKpLOuECQShoNN85vL2t8K
...
# Jalankan sel notebook agar menghasilkan output (plot, dsb)
with open('/content/drive/MyDrive/ML Terapan/Predictive/analisis_predictive.ipynb', 'r', encoding='utf-8') as f:
    notebook = nbformat.read(f, as_version=4)

# Jalankan notebook agar semua output tersedia
ep = ExecutePreprocessor(timeout=600, kernel_name='python3')
ep.preprocess(notebook, {'metadata': {'path': '/content'}})

# Konversi ke markdown dengan gambar inline
