...
![Output 0](images_ml2/output_0.png)

![Output 1](images_ml2/output_1.png)

![Output 2](images_ml2/output_2.png)
...
![Output 3](images_ml2/output_3.png)
...
```python
# Loop melalui setiap kolom kategorikal yang Anda miliki
for col in kolom_kategorikal:

    # KOREKSI: Buat penanganan khusus jika kolomnya adalah 'Model Name'
    if col == 'Model Name':
        print("Membuat plot khusus untuk 'Model Name' (20 termahal)...")
        # Karena jumlah model sangat banyak, kita hanya akan menampilkan 20 model dengan rata-rata harga tertinggi.

        # 1. Hitung rata-rata harga untuk setiap model
        harga_per_model = data_gabungan.groupby('Model Name')['Launched Price (China/CNY)'].mean()

        # 2. Urutkan dan ambil 20 model teratas
        top_20_models = harga_per_model.sort_values(ascending=False).head(20)

        # 3. Buat visualisasi untuk data yang sudah diringkas ini
        plt.figure(figsize=(15, 7)) # Gunakan ukuran berbeda agar lebih pas
        ...
        plt.xticks(rotation=45, ha='right') # Putar label agar tidak tumpang tindih

    # PARAFRASE: Untuk kolom kategorikal lainnya, gunakan sns.barplot
    else:
        # Gunakan sns.barplot yang merupakan fungsi level-axes, bukan catplot (level-figure)
        plt.figure(figsize=(12, 5)) # Atur ukuran figur secara manual
...
![Output 4](images_ml2/output_4.png)

![Output 5](images_ml2/output_5.png)

![Output 6](images_ml2/output_6.png)
...
![Output 7](images_ml2/output_7.png)
...
![Output 8](images_ml2/output_8.png)
...
![Output 9](images_ml2/output_9.png)
...
![Output 10](images_ml2/output_10.png)
...
# Buat Company Mapping dan Model Mapping dari df_original
...
# Jika ingin mengganti kolom numerik yang sudah ada dengan nilai asli:
